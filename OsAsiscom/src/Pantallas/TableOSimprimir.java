...
import static Pantallas.EstadoOS.NumOS;
 ...
 * @author rica_
 */
public class TableOSimprimir extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TableOSimprimir.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TableOSimprimir().setVisible(true);
            }
        });
    }
